...
def main() -> None:
    ...
    selected_env = {
        ...
        in {
            ...
            "LLAMA_MMAP_POPULATE_POLICY",
            "LLAMA_MMAP_AUTO_POPULATE_FIT_THRESHOLD",
            "LLAMA_MMAP_POPULATE_AUDIT",
            "LLAMA_MMAP_DECODE_NORMAL",
            "LLAMA_EXPERT_BOUNDARY_PROBE",
            "LLAMA_EXPERT_BOUNDARY_PROBE_MAX_PAIRS",
            "TRACE_PROFILE",
            "OMP_NUM_THREADS",
            "OMP_DYNAMIC",
