...
PRESSURE_SHADOW_MODE="${LLM_MEM_TRACE_PRESSURE_SHADOW_MODE:-off}"
...
case "$PRESSURE_SHADOW_MODE" in
    off|summary|detail) ;;
    *)
        echo "ERROR: LLM_MEM_TRACE_PRESSURE_SHADOW_MODE must be off, summary, or detail" >&2
        exit 1
        ;;
esac
...
export LLM_MEM_TRACE_OPT_EXPERT_SLACK_MODE="${LLM_MEM_TRACE_OPT_EXPERT_SLACK_MODE:-off}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WINDOW="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WINDOW:-64}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MIN_SAMPLES="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MIN_SAMPLES:-8}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_EWMA_ALPHA="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_EWMA_ALPHA:-0.2}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_HORIZON_DEFAULT_US="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_HORIZON_DEFAULT_US:-5000}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_HORIZON_MIN_US="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_HORIZON_MIN_US:-1}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_HORIZON_MAX_US="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_HORIZON_MAX_US:-5000000}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WORKER_DEFAULT_US="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WORKER_DEFAULT_US:-50}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WORKER_MIN_US="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WORKER_MIN_US:-1}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WORKER_MAX_US="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_WORKER_MAX_US:-1000000}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_THROUGHPUT_DEFAULT_MIB_S="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_THROUGHPUT_DEFAULT_MIB_S:-512}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MAX_PENDING="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MAX_PENDING:-8192}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MAX_FIRST_USE_KEYS="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MAX_FIRST_USE_KEYS:-65536}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MAX_CELLS="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_MAX_CELLS:-4096}"
export LLM_MEM_TRACE_OPT_EXPERT_SHADOW_STEP_RETENTION="${LLM_MEM_TRACE_OPT_EXPERT_SHADOW_STEP_RETENTION:-2}"
...
export LLM_MEM_TRACE_PRESSURE_SHADOW_MODE="${LLM_MEM_TRACE_PRESSURE_SHADOW_MODE:-off}"
export LLM_MEM_TRACE_PRESSURE_SHADOW_SAMPLE_MS="${LLM_MEM_TRACE_PRESSURE_SHADOW_SAMPLE_MS:-25}"
export LLM_MEM_TRACE_PRESSURE_SHADOW_PSS_SAMPLE_MS="${LLM_MEM_TRACE_PRESSURE_SHADOW_PSS_SAMPLE_MS:-2000}"
