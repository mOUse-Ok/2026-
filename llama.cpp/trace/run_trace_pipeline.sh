...
case "$EXPERT_PROFILE" in
    custom)
        ...
        PROFILE_EXPERT_PRELOAD=0
        PROFILE_EXPERT_PRELOAD_KV_MB=0
        PROFILE_EXPERT_PRELOAD_BUFFER_MB=0
        ;;
    survival)
    ...
    performance)
        ...
        PROFILE_CTX_SIZE=2048
        PROFILE_FLASH_ATTN=auto
        # These are reservations used before llama_context exists. They are
        # deliberately conservative for the bundled CPU model at c=2048.
        PROFILE_EXPERT_PRELOAD=1
        PROFILE_EXPERT_PRELOAD_KV_MB=256
        PROFILE_EXPERT_PRELOAD_BUFFER_MB=512
        ;;
    *)
...
export LLM_MEM_TRACE_OPT_EXPERT_MADV_RANDOM="${LLM_MEM_TRACE_OPT_EXPERT_MADV_RANDOM:-0}"
export LLM_MEM_TRACE_OPT_EXPERT_MADV_RANDOM_MAX_REGIONS="${LLM_MEM_TRACE_OPT_EXPERT_MADV_RANDOM_MAX_REGIONS:-1024}"
export LLAMA_MMAP_SKIP_SEQUENTIAL_FADVISE="${LLAMA_MMAP_SKIP_SEQUENTIAL_FADVISE:-0}"
export LLAMA_MMAP_SKIP_POPULATE="${LLAMA_MMAP_SKIP_POPULATE:-0}"
export LLAMA_MMAP_POPULATE_POLICY="${LLAMA_MMAP_POPULATE_POLICY:-default}"
export LLAMA_MMAP_AUTO_POPULATE_FIT_THRESHOLD="${LLAMA_MMAP_AUTO_POPULATE_FIT_THRESHOLD:-1.0}"
export LLAMA_MMAP_POPULATE_AUDIT="${LLAMA_MMAP_POPULATE_AUDIT:-0}"
export LLAMA_MMAP_DECODE_NORMAL="${LLAMA_MMAP_DECODE_NORMAL:-0}"
export LLAMA_EXPERT_BOUNDARY_PROBE="${LLAMA_EXPERT_BOUNDARY_PROBE:-0}"
export LLAMA_EXPERT_BOUNDARY_PROBE_MAX_PAIRS="${LLAMA_EXPERT_BOUNDARY_PROBE_MAX_PAIRS:-12}"
...
export LLM_MEM_TRACE_OPT_DETERMINISTIC_PREFETCH="${LLM_MEM_TRACE_OPT_DETERMINISTIC_PREFETCH:-0}"
export LLM_MEM_TRACE_OPT_DETERMINISTIC_PREFETCH_SHADOW="${LLM_MEM_TRACE_OPT_DETERMINISTIC_PREFETCH_SHADOW:-0}"
...
export LLM_MEM_TRACE_OPT_EXPERT_PRELOAD="${LLM_MEM_TRACE_OPT_EXPERT_PRELOAD:-$PROFILE_EXPERT_PRELOAD}"
export LLM_MEM_TRACE_OPT_EXPERT_PRELOAD_KV_MB="${LLM_MEM_TRACE_OPT_EXPERT_PRELOAD_KV_MB:-$PROFILE_EXPERT_PRELOAD_KV_MB}"
export LLM_MEM_TRACE_OPT_EXPERT_PRELOAD_BUFFER_MB="${LLM_MEM_TRACE_OPT_EXPERT_PRELOAD_BUFFER_MB:-$PROFILE_EXPERT_PRELOAD_BUFFER_MB}"
export LLM_MEM_TRACE_OPT_EXPERT_PRELOAD_SAFETY_PCT="${LLM_MEM_TRACE_OPT_EXPERT_PRELOAD_SAFETY_PCT:-80}"
