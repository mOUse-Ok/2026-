...
export LLM_MEM_TRACE_OPT_EXPERT_ASYNC="${LLM_MEM_TRACE_OPT_EXPERT_ASYNC:-0}"
export LLM_MEM_TRACE_OPT_EXPERT_ASYNC_QUEUE="${LLM_MEM_TRACE_OPT_EXPERT_ASYNC_QUEUE:-65536}"
export LLM_MEM_TRACE_OPT_EXPERT_ASYNC_WORKERS="${LLM_MEM_TRACE_OPT_EXPERT_ASYNC_WORKERS:-1}"
export LLM_MEM_TRACE_OPT_EXPERT_ASYNC_PRIORITY="${LLM_MEM_TRACE_OPT_EXPERT_ASYNC_PRIORITY:-0}"
export LLM_MEM_TRACE_OPT_EXPERT_ASYNC_PRIORITY_MODE="${LLM_MEM_TRACE_OPT_EXPERT_ASYNC_PRIORITY_MODE:-score}"
export LLM_MEM_TRACE_OPT_EXPERT_ASYNC_PRIORITY_HEAP="${LLM_MEM_TRACE_OPT_EXPERT_ASYNC_PRIORITY_HEAP:-0}"
